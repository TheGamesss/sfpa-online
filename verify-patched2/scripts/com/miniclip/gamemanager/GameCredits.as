package com.miniclip.gamemanager
{
   ...
   public interface GameCredits extends IEventDispatcher
   {
      ...
      function purchaseProducts(param1:Array, param2:int, param3:String = null, param4:Boolean = false) : void;
      
      function getProductsByGameId(param1:Boolean = true) : void;
      
      function getProductById(param1:int) : void;
      
      function getVendorIcon() : VendorIcon;
      
      function getSecondaryVendorIcon() : VendorIcon;
      
      function getVendorLogo() : VendorIcon;
      
      function get capabilities() : CreditsCapabilities;
   }
}
