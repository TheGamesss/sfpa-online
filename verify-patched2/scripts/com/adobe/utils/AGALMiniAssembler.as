package com.adobe.utils
{
   ...
   public class AGALMiniAssembler
   {
      ...
      {
         REGMAP[VA] = new Register(VA,"vertex attribute",0,ignorelimits ? 1024 : (version == 1 || version == 2 ? 7 : 15),REG_VERT | REG_READ);
         REGMAP[VC] = new Register(VC,"vertex constant",1,ignorelimits ? 1024 : (version == 1 ? 127 : 249),REG_VERT | REG_READ);
         REGMAP[VT] = new Register(VT,"vertex temporary",2,ignorelimits ? 1024 : (version == 1 ? 7 : 25),REG_VERT | REG_WRITE | REG_READ);
         REGMAP[VO] = new Register(VO,"vertex output",3,ignorelimits ? 1024 : 0,REG_VERT | REG_WRITE);
         REGMAP[VI] = new Register(VI,"varying",4,ignorelimits ? 1024 : (version == 1 ? 7 : 9),REG_VERT | REG_FRAG | REG_READ | REG_WRITE);
         REGMAP[FC] = new Register(FC,"fragment constant",1,ignorelimits ? 1024 : (version == 1 ? 27 : (version == 2 ? 63 : 199)),REG_FRAG | REG_READ);
         REGMAP[FT] = new Register(FT,"fragment temporary",2,ignorelimits ? 1024 : (version == 1 ? 7 : 25),REG_FRAG | REG_WRITE | REG_READ);
