package com.amanitadesign.steam
{
   ...
   public class FRESteamWorks extends EventDispatcher
   {
      ...
      {
         var extensionContextClass:Class;
         super(target);
         try
         {
            extensionContextClass = getDefinitionByName("flash.external.ExtensionContext") as Class;
      ...
      private function handleStatusEvent(event:StatusEvent) : void
      {
         ...
         if(Boolean(this._redrawContainer) && !this._alwaysVisible && req_type == SteamConstants.RESPONSE_OnGameOverlayActivated)
         {
