package
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="symbol6138")]
   public class Ninja extends Baddies
   {
      ...
      private var popN:uint = 0;
      
      private var freeze:Boolean;
      
      public function Ninja(p:*)
      {
         var i:String = null;
      ...
      public function ChargeEnterFrame() : *
      {
      ...
      public function AttackEnterFrame() : *
      {
         var dist:int = 0;
         this.baddie.nextFrame();
         smokeSetFrame();
