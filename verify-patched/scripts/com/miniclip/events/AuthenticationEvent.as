package com.miniclip.events
{
   ...
   public class AuthenticationEvent extends Event
   {
      ...
      public static const NOT_LOGGED_IN:String = "auth_not_logged_in";
      ...
      public function AuthenticationEvent(type:String, data:* = null, bubbles:Boolean = false, cancelable:Boolean = false)
      {
      ...
      {
         return new AuthenticationEvent(type,this.data,bubbles,cancelable);
      }
   }
}
