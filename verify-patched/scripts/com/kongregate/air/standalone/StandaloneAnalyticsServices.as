package com.kongregate.air.standalone
{
   ...
   public class StandaloneAnalyticsServices extends AnalyticsServices
   {
      
      public function StandaloneAnalyticsServices(api:StandaloneInternal)
      {
         super(api);
      }
      
      override protected function getSDKVersion() : String
      {
         return Version.SDK_VERSION;
      }
      
      override protected function updateKongStaticVars(payload:Object) : void
      {
