package
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="symbol6409")]
   public class InkFly extends Baddies
   {
      ...
      public function InkFly(p:*)
      {
         ...
         springy = 10;
         stunMax = 120;
         health = healthMax = isTall * isWide / 20;
