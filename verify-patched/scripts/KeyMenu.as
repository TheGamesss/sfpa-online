package
{
   ...
   public class KeyMenu extends MovieClip
   {
      
      public static var keymenu:Object;
      ...
      public function PauseEnterFrame() : *
      {
         if(alpha != 1)
         {
            if(alpha < 1)
      ...
      private function BuyAKey(e:MouseEvent) : *
      {
