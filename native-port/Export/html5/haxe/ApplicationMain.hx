...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("NativePort", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("NativePort", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "NativePort";
		app.meta["name"] = "NativePort";
		app.meta["packageName"] = "com.sample.nativeport";
