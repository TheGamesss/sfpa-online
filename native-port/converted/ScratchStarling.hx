...
class ScratchStarling extends StarlingInteract
{
    ...
    private function getAttackedShared(ex : Dynamic, ey : Dynamic, angle : Dynamic, char : Dynamic, hitMove : Dynamic, hitPower : Dynamic) : Void
    {
        var tempUD : Float = Math.NaN;
        shakeRL = hitPower + 10;
        downTime = 6;
        if (hitMove == "PokeDown")
        {
    ...
    public function nowSpeed() : Dynamic
    {
