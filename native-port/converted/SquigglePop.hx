...
@:meta(Embed(source="/_assets/assets.swf",symbol="symbol2553"))

class SquigglePop extends StaticInteractObjects
{
    ...
    public function currentGetAttacked(ex : Dynamic, ey : Dynamic, ang : Dynamic, char : Dynamic, hitMove : Dynamic, hitPower : Dynamic) : Bool
    {
        angle = ang - 3.14;
        this.pop();
        return true;
    ...
    public function pop(e : Dynamic) : Dynamic
    {
