...
class Message
{
    ...
    public static inline var NORMAL_TYPE : String = "normal";
    
    public static inline var CHAT_TYPE : String = "chat";
    
    public static inline var GROUPCHAT_TYPE : String = "groupchat";
    
    public static inline var HEADLINE_TYPE : String = "headline";
    
    public static inline var ERROR_TYPE : String = "error";
    
    private var mOpcode : String;
    
    private var mParams : Dynamic;
    ...
    public static function fromObject(obj : Dynamic) : Message
    {
    ...
    public static function fromString(text : String) : Message
    {
        ...
        try
        {
            ...
            for (key in Reflect.fields(jsonObject.mParams))
            {
    ...
    public function addParam(key : String, value : Dynamic) : Void
    {
        this.mParams[key] = value;
    }
    
    public function getParam(key : String) : Dynamic
    {
    ...
    public function getRequestID() : Float
    {
    ...
    public function getError() : Int
    {
        ...
        return (error != 0) ? ErrorCode.NONE : error;
    }
