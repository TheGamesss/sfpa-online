...
@:meta(Embed(source="/_assets/assets.swf",symbol="symbol4047"))

class IceCreamPickup extends InteractObjects
{
    ...
    public function new(ex : Float, ey : Float, eRL : Float, eUD : Float, rail : Int, id : Int)
    {
        super(rail);
        rotter = eRL * 2;
        ...
        moveUD = as3hx.Compat.parseInt(eUD);
        ItIs = "iceCreamPickup";
        downTime = 5;
        this.ID = id;
    ...
    public function updateStats(char : Dynamic) : Void
    {
        if (this.ID == 0)
        {
