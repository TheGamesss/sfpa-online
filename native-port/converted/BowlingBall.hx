...
@:meta(Embed(source="/_assets/assets.swf",symbol="symbol7035"))

class BowlingBall extends Baddies
{
    ...
    public function new(p : Dynamic)
    {
        ...
        Status = "Wait";
        currentGetAttacked = function(ex : Dynamic, ey : Dynamic, eRL : Dynamic, eUD : Dynamic, char : Dynamic, hitMove : Dynamic, hitPower : Dynamic) : Dynamic
                {
                };
    ...
    public function FallEnterFrame() : Dynamic
    {
        var land : Int = 0;
        var scale : Int = 0;
        var crack : Level1Crack = null;
    ...
    private function FinishEnterFrame() : Dynamic
    {
        if (this.b > 0)
        {
            --this.b;
