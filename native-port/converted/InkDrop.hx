...
@:meta(Embed(source="/_assets/assets.swf",symbol="symbol5302"))

class InkDrop extends InteractObjects
{
    ...
    public function new(ex : Dynamic, ey : Dynamic, rail : Dynamic, gY : Dynamic, spawn : Dynamic)
    {
        super();
        isWide = 2;
        isTall = 10;
