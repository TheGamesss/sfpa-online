...
@:meta(Embed(source="/_assets/assets.swf",symbol="symbol1734"))

class WindowCutscene extends StaticInteractObjects
{
        ...
        if (this.state == 0)
        {
            ...
            else
            {
                ...
                else if (this.flashes == -1)
                {
                    ...
                    this.b = 60 + as3hx.Compat.parseInt(Math.random() * 40);
                }
                else if (this.flashes < 0)
                {
                    ++this.flashes;
