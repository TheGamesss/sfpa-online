package
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="symbol7540")]
   public class Boss1 extends Baddies
   {
      
      public var baddie:MovieClip;
      
      private var bossTimer:uint = 0;
      ...
      public var handRCacheN:uint;
      
      public var handLCacheN:uint;
      
      public var bodyCacheN:uint;
      
      public function Boss1(p:*)
      {
         var i:String = null;
         super(2000,1000,1);
         for(i in p)
         ...
         currentGetAttacked = function(ex:*, ey:*, angle:*, char:*, hitMove:*, hitPower:*):Boolean
         {
         };
         springDecay = 1;
         springThresh = 3;
      ...
      private function boss1HitChar(ex:*, ey:*, eRL:*, eUD:*, ax:*, ay:*, char:*) : String
      {
         this.targetX = ex;
         this.targetY = ey;
      }
      ...
      public function EmergeEnterFrame() : *
      {
      ...
      private function moveEyes(ex:*, ey:*) : *
      {
         ++this.bossTimer;
