package
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="symbol6264")]
   public class Mouse extends Baddies
   {
      ...
      private var rootShootN:uint;
      
      private var inARow:uint;
      
      private var shotSpeed:uint;
      
      public function Mouse(p:*)
      {
         ...
         if(p.shotSpeed == undefined || p.shotSpeed == -1)
         {
            this.shotSpeed = 10;
         }
         else
