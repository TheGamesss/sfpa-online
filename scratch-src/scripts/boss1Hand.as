package
{
   ...
   public class boss1Hand extends InteractObjects
   {
      
      private var waveB:uint = 0;
      
      private var b:uint = 0;
      
      private var anchorX:Number = -350;
      
      private var anchorY:Number = -50;
      
      private var state:uint = 0;
      
      private var sinMove:Number = 1.57;
      
      private var attackN:uint = 0;
      
      private var myBoss1:Baddies;
      
      public var myCacheN:uint;
      ...
      public function boss1Hand(ex:int, ey:int, boss:Boss1)
      {
         super();
         ItIs = "boss1Hand";
         BallRes = 0;
